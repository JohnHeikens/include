...
{
	*(int*)result->var = *(fp*)arguments[0]->var;
}
...
void GenerateStandardArea()
{
	...
	standardArea->variables.push_back(new variable(tfp, (void*)new fp(math::PI), L"pi"));
	standardArea->variables.push_back(new variable(tfp, (void*)new fp(math::goldenratio), L"goldenratio"));
}
